# Health Impact in Venezuela (2024–2025): Key Indicators, Factors and Disease Data
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18985554.svg)](https://doi.org/10.5281/zenodo.18985554)
...
[![Pages](https://img.shields.io/badge/Live-Microsite-brightgreen)](https://juanmoisesd.github.io/health-impact-in-venezuela-20242025-key-indicators-factors-and-disease-data/)

## Overview
Comprehensive dataset of key health indicators for Venezuela (2020-2025). Includes mental health metrics (depression, anxiety, suicide rates), healthcare workforce decline, infectious disease burden (malaria, dengue, HIV, measles), non-communicable disease prevalence, healthcare system capacity, and migration-related health impacts. Sources: PAHO, WHO, World Bank, ACNUR/UNHCR, IOM, UNAIDS.

## Dataset Status
| Field | Value |
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18985554](https://doi.org/10.5281/zenodo.18985554) |
| Platform | Zenodo |
| License | CC0 1.0 |
| Published | 2026-03-12 |

## 🌐 Interactive Microsite
**[Open Microsite](https://juanmoisesd.github.io/health-impact-in-venezuela-20242025-key-indicators-factors-and-disease-data/)**

## Keywords
Venezuela, health indicators, mental health, malaria, public health, healthcare crisis, PAHO, longitudinal dataset

## Citation
> de la Serna Tuya, J.M. (2026). *Health Impact in Venezuela (2024–2025): Key Indicators, Fact*. Zenodo. https://doi.org/10.5281/zenodo.18985554
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Comprehensive dataset of key health indicators for Venezuela (2020-2025). Includes mental health metrics (depression, anxiety, suicide rates), healthcare workforce decline, infectious disease burden (malaria, dengue, HIV, measles), non-communicable d* [Dataset]. GitHub. https://github.com/juanmoisesd/health-impact-in-venezuela-20242025-key-indicators-factors-and-disease-data

**BibTeX**
```bibtex
@dataset{delaserna2025_health_impact_in_venezuela_202,
